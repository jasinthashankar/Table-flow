    ...
    <div className="home-page page-enter">
        ...
        <div className="hero__inner">
          <div>
            ...
            <p className="hero__copy">
              TableFlow unifies reservations, floor status, waitlists and service requests in a focused MERN workspace built for real restaurant operations.
            </p>
      ...
      <section id="technology" className="tech-strip">
        <div className="tech-strip__inner">
          <span>Built as a complete MERN application</span>
          <div className="tech-logos"><span>MongoDB Atlas</span><span>Express</span><span>React</span><span>Node.js</span><span>JWT</span><span>Zod</span></div>
        </div>
      </section>
    </div>
  );
