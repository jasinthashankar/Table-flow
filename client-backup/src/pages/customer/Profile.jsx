...
const Profile = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-8 page-enter">
      {/* Welcome Board */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 bg-white border border-slate-200 p-8 rounded-xl shadow-sm">
        <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <div className="md:col-span-1 bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-6">
