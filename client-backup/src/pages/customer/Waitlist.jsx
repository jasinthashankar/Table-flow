...
const Waitlist = () => {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-8 space-y-6 page-enter">
      ...
      {activeEntry ? (
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-8 shadow-sm text-center space-y-6">
          ...
          <div className="bg-slate-50 rounded-lg p-5 border border-slate-200 text-left space-y-3 text-sm">
