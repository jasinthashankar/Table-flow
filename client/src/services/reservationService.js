...
// Admin: Assign table
export const adminAssignTable = (reservationNumber, tableOrPayload) => {
  const payload =
    typeof tableOrPayload === 'string'
      ? { tableId: tableOrPayload }
      : tableOrPayload;

  return api.patch(`/reservations/${reservationNumber}/assign-table`, payload);
};
