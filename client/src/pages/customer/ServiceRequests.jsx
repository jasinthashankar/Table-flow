...
const ServiceRequests = () => {
  ...
  return (
    <div className="service-page max-w-6xl mx-auto px-4 py-8 space-y-6 page-enter">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Left Column: Form */}
        <div className="service-panel rounded-xl p-6 h-fit">
        ...
        <div className="service-panel lg:col-span-2 rounded-xl p-6">
          <h2 className="text-base font-semibold text-slate-900 pb-3 border-b border-slate-100 mb-5">
